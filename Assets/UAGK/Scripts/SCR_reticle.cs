...
public class SCR_reticle : MonoBehaviour {
	...
	void Awake () {
		...
		GetComponent<Renderer>().material.mainTexture=reticleTexture;
	...
	void DisplayAlpha(){
		GetComponent<Renderer>().material.SetColor("_TintColor",new Color(0.5f,0.5f,0.5f,(alpha[0]*reticleAlpha*0.5f)));
	}
}
