...
public class SCR_text : MonoBehaviour {
	...
	public void UpdatePos(){
		...
		Vector3 camPos=cam.GetComponent<Camera>().WorldToViewportPoint(worldPos);
	...
	void DisplayAlpha(){
		GetComponent<GUIText>().color=new Color(textColour.r,textColour.g,textColour.b,alpha[0]);	
	}
